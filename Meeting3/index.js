...
const toSummer = new Date(2020, 7, 1);
const toEndOfMonth = new Date(2020, 4, 30);
...
const counter2 = makeCounterElement({
    title: 'До Лета осталось',
    data: getCountdownData( toSummer )
});
const counter3 = makeCounterElement({
    title: 'До конца месяца осталось',
    data: getCountdownData( toEndOfMonth )
});
render( [counter1.container, counter2.container,
        counter3.container], rootEl );

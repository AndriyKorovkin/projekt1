...
function maxScore( grade ) {    //Домашнее задание
...
console.log('2. Max score:', maxScore(grade));
...
console.log('5. First three winner:', firstThree( grade ));
